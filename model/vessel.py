...
from weapon import Weapon
from weapon import Lancemissileantisurface, Lancemissileantiair, Lancetorpilles
...
class Cruiser(Vessel):
    def __init__(self, coordinates: Tuple, max_hits: int, weapon: Weapon):
        super().__init__(coordinates, 6, Lancemissileantiair())
    def go_to(self, x, y, z):
        if z==0:
            super().go_to(x,y,z)
...
class Submarine(Vessel):
    def __init__(self, coordinates: Tuple, max_hits: int, weapon: Weapon):
        super().__init__(coordinates, 2, Lancetorpilles())
    def go_to(self, x, y, z):
        if z<0:
            super().go_to(x, y, z)
...
class Fregate(Vessel):
    def __init__(self, coordinates: Tuple, max_hits: int, weapon: Weapon):
        super().__init__(coordinates, 5, Lancemissileantisurface())
    def go_to(self, x, y, z):
        if z == 0:
            super().go_to(x, y, z)
...
class Destroyer(Vessel):
    def __init__(self, coordinates: Tuple, max_hits: int, weapon: Weapon):
        super().__init__(coordinates, 4, Lancetorpilles())
    def go_to(self, x, y, z):
        if z == 0:    
            super().go_to(x, y, z)
...
class Aircraft(Vessel):
    def __init__(self, coordinates: Tuple, max_hits: int, weapon: Weapon):
        super().__init__(coordinates, 1, Lancemissileantisurface())
    def go_to(self, x, y, z):
        if z == 1:
            super().go_to(x, y, z)    
